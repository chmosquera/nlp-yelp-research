...
def loadData():
    ...
    # Use Regex to remove emails and new line chars
...
## Remvoe Stopwords, make bigrams, lemmatize
...
def buildLDAModel():
    ...
    corpus = [id2word.doc2bow(text) for text in texts]      # token2id : token -> tokenid; id2token : reverse mapping of token2id; doc2bow : convert doc to bag of words
