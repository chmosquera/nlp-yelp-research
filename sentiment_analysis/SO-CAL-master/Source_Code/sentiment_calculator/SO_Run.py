...
def main():
    ...
    if os.path.isfile(input_path):  # 1 single file
        ...
        cmd = PY_CMD + " sentiment_calculator/SO_Calc.py -i \"" + input_path + "\" -bo \"" + basicout_path + "\" -ro \"" + richout_path + "\" -c \"" + config_file + "\""
        os.system(cmd)
        ...
        for f_name in os.listdir(input_path):
            ...
            cmd = PY_CMD + " sentiment_calculator/SO_Calc.py -i \"" + file_path + "\" -bo \"" + basicout_path + "\" -ro \"" + richout_path + "\" -c \"" + config_file + "\""
            os.system(cmd)
